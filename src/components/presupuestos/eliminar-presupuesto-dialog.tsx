...
interface EliminarPresupuestoDialogProps {
...
export function EliminarPresupuestoDialog({ 
  presupuestoId,
  presupuestoNumero,
  trigger,
  onSuccess
}: EliminarPresupuestoDialogProps) {
  ...
  const handleDelete = async () => {
    try {
      ...
      if (onSuccess) {
        ...
        // Si no hay callback de éxito, redirigir a la lista de presupuestos
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Esta acción eliminará permanentemente el presupuesto <strong>#{presupuestoNumero}</strong> y no se puede deshacer.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
